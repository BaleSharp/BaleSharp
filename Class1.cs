...
namespace Bale.net
{
    ...
    public class Client
    {
        ...
        public Client(string token, string? _baseUrl)
        {
    ...
    public static class Bot
    {
        ...
        public static async Task<string> ExecuteAsync(this Client client, string method, Dictionary<string, object> parameters)
        {
